    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-slate-200">
          ...
          <CardContent>
            <div className="text-3xl font-extrabold text-slate-900">{metrics?.kpis?.laundryTaktTime || '0.0h'}</div>
        ...
        <Card className="border-slate-200">
          ...
          <CardContent>
            <div className="text-3xl font-extrabold text-slate-900">{metrics?.kpis?.slaCompliance || '100%'}</div>
        ...
        <Card className="border-slate-200">
          ...
          <CardContent>
            <div className="text-3xl font-extrabold text-slate-900">{metrics?.summary?.activeUsers || 0}</div>
