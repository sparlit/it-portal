"use client"
import { AssetHierarchy } from "@/components/modules/it/AssetHierarchy"
        ...
        <Tabs defaultValue="analytics" className="w-full">
          <div className="overflow-x-auto pb-4 scrollbar-hide">
            <TabsList className="flex h-auto gap-2 bg-transparent p-0 min-w-max">
              ...
              <TabsTrigger value="it-map" className="border font-bold">Hierarchy Map</TabsTrigger>
