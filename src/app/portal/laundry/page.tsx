"use client"
import { PipelineTracker } from "@/components/modules/laundry/PipelineTracker"
  ...
  return (
    <main className="container mx-auto p-4 md:p-8" style={{ '--primary-brand': theme.primaryColor } as any}>
      <div className="flex flex-col gap-8">
        <PipelineTracker stages={[{ name: "Sorting", status: "completed" }, { name: "Washing", status: "in_progress" }, { name: "Drying", status: "pending" }, { name: "Ironing", status: "pending" }, { name: "Packing", status: "pending" }]} />
